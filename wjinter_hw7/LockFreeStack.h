...
//Please just run this as given for testing if needed
//clang++ -std=c++14 TestStack.cpp -o test

//My result
/*
OS-3:wjinter_hw7 Wen$ clang++ -std=c++1z TestStack.cpp -o test
OS-3:wjinter_hw7 Wen$ ./test
5
3
1
*/
